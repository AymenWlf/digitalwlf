        ...
        <div class="row">
          ...
          >
            ...
            <p data-aos="fade-up">
              ...
              est d'intégrer dans le domaine du web une nouvelle vision basée
              sur les nouvelles technologies, nous visons toujours l'excellence
              et la satisfaction de nos clients, car nous croyons que gagner une
              part d'un grannnn...d gâteau est meilleure que de gagner un petit
              gateau complet.
            </p>
            ...
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">
                ...
                <strong>JEUX D'ARGENT</strong>,
                <strong>INDUSTRIE DU SEXE</strong>, <strong>ARMEMENT</strong>,
                <strong>ALCOOL ET STUPEFIANT</strong> <br />
                En revanche, nous sommes obligées de vous proposer des projets
                de bonnes qualités, et un service chaleureux et respectueux
              </p>
            </div>

            <!-- <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              <div class="icon"><i class="bx bx-atom"></i></div>
              <h4 class="title"><a href="">Gagner</a></h4>
              <p class="description">
